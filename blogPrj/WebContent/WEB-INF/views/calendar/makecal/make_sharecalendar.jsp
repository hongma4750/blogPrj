...
<script>
$(function () {
	var chk_yes = $(this).find('#yes_share').is(":checked");
		...
		<tr>
	    	...
	    	<td colspan="3">
	    		<div class="" style="display: inline-block;">
					<p class="ck_state">
						<input type="radio" id="no_share" name="set_share_mode" value="no_share"><label for="no_share">혼자 사용하기</label>
						<input type="radio" id="yes_share" name="set_share_mode" value="yes_share" checked=""><label for="yes_share">친구와 사용하기</label>	
					</p>
					<c:if test=""></c:if>
